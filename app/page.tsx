...
function createGeneratedPlayer(
  ...
  if (hiddenType === "talent") {
    baseValue = randomBetween(8, 20);
  }

  if (hiddenType === "normal") {
    baseValue = randomBetween(3, 10);
  }

  if (hiddenType === "flop") {
    baseValue = randomBetween(1, 6);
  }
  ...
  return {
    ...
    assists,
    cleanSheets,
    yellowCards: randomBetween(0, 10),
    redCards: randomBetween(0, 2),
    rating,
    values,
  };
}
        ...
        {mode && (
          <>
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-6">
              ...
              {[
                ...
                <button
                  ...
                  className={`px-5 py-3 rounded-xl border-2 transition-all duration-150 active:scale-95 active:translate-y-1 ${
                    selectedTime ===
                    t.value
                      ? "bg-yellow-600 border-yellow-300 shadow-lg shadow-yellow-500/30"
            ...
            <button
              ...
              className="bg-white text-black px-8 py-4 rounded-xl text-xl disabled:bg-gray-500 border-2 border-white transition-all duration-150 active:scale-95 active:translate-y-1"
            >
              Start Game
            </button>
          ...
          <div className="bg-zinc-900 border border-gray-700 rounded-2xl p-8 text-center max-w-md w-full">
            ...
            <div className="flex gap-4 justify-center">
              ...
              <button
                ...
                className="bg-red-700 px-5 py-3 rounded-xl transition-all duration-150 active:scale-95 active:translate-y-1"
              >
                Sell Player
              </button>
              ...
              <button
                ...
                className="bg-green-700 px-5 py-3 rounded-xl transition-all duration-150 active:scale-95 active:translate-y-1"
              >
                Keep Player
              </button>
            ...
            {!stealChallenge.success ? (
              <>
                ...
                {stealChallenge.showHelp && (
                  <p className="bg-black/40 p-4 rounded-xl mb-4 text-right">
                    ...
                    بعدها أول شخص يقول اسم لاعب لعب للناديين يفوز.

                    مثال:

                    Everton + Manchester United = Wayne Rooney
                  </p>
                )}
                ...
                <div className="flex gap-4 justify-center">
                  ...
                  <button
                    ...
                    className="bg-blue-600 px-5 py-3 rounded-xl transition-all duration-150 active:scale-95 active:translate-y-1"
                  >
                    Player 1 Won
                  </button>
                  ...
                  <button
                    ...
                    className="bg-green-600 px-5 py-3 rounded-xl transition-all duration-150 active:scale-95 active:translate-y-1"
                  >
                    Player 2 Won
                  </button>
              ...
              <>
                  ...
                  <div>
                    ...
                    {gamePlayers[
                      ...
                      <button
                        ...
                        className={`block w-full text-left p-3 rounded-lg mb-2 transition-all duration-150 ${
                ...
                <div className="flex gap-4 justify-center mt-6">
                  ...
                  <button
                    onClick={swapPlayers}
                    className="bg-purple-700 px-5 py-3 rounded-xl transition-all duration-150 active:scale-95 active:translate-y-1"
                  >
                    Confirm Swap
                  </button>
                  ...
                  <button
                    ...
                    className="bg-gray-700 px-5 py-3 rounded-xl transition-all duration-150 active:scale-95 active:translate-y-1"
                  >
                    Cancel
                  </button>
